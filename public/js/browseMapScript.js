...
// function
/****************************************************
        object data from socket - distance
    .place
    .lat
    .lng
    .address
...
*****************************************************/
    ...
    // var primaryChevron = document.getElementById( 'primary-chevron-icon' );
    // var secondaryChevron = document.getElementById( 'secondary-chevron-icon' );
    // var height = Math.round( overlay.clientHeight/window.innerHeight + 'e2' );
    // if( height === 40 && toggle ) {
    //     var contentOne = document.getElementById( 'overlay-content-one' );
    //     var contentTwo = document.getElementById( 'overlay-content-two' );
    //     if(  window.getComputedStyle( contentTwo, null ).display === 'block' ) {
    //         contentOne.style.display = 'block';
    //         contentTwo.style.display = 'none';
    //     }
    //     overlay.style.height = '50px';
    //     primaryChevron.style.transform = 'rotate( -90deg )';
    //     secondaryChevron.style.opacity = '0';
    // }
    // else {
    //     overlay.style.height = '40%';
    //     // primaryChevron.style.transform = 'rotate( -270deg )';
    //     // secondaryChevron.style.opacity = '1';
    //
    // }
    //
    // socket.emit( 'distanceRequest', null );
    // socket.on( 'distanceReturn', function( distances ) {
    //     var content = '<div class="main-overlay-content">'
    //     for( var i in distances ) {
    //         content += (
